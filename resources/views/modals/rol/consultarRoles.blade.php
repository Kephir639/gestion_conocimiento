                                        ...
                                        @if ($controlador['nombre_controlador'] == 'roles')
                                            @foreach ($controlador['funciones'] as $func)
                                                @if ($func['nombre_funcion'] == 'modificar_rol')
                                                    <button title="Modificar rol" class="btn iconoModificar p-0"><svg
                                                            class="iconoM" width="34" height="34"
                ...
                @if ($controlador['nombre_controlador'] == 'roles')
                    @foreach ($controlador['funciones'] as $func)
                        @if ($func['nombre_funcion'] == 'crear_rol')
                            <button title="Registrar Rol" id="BtnRegistrarRol" class="btn iconoRegistrar p-0"><svg
