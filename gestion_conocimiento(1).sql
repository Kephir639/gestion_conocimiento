...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-08-2024 a las 18:01:02
...
CREATE TABLE `controladores` (
  ...
  `display_icon` varchar(2000) NOT NULL
...
CREATE TABLE `funciones` (
  ...
  `display_funcion` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `funciones` (`id_funcion`, `id_controlador`, `nombre_funcion`, `display_funcion`) VALUES
...
(29, 1, 'modificar_usuario', 'Modificar usuario'),
...
(35, 7, 'modificar_red', 'Modificar red'),
...
CREATE TABLE `integrantes` (
  ...
  `estado_integrantes` int(11) NOT NULL,
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(8, 'Estudios Ambientales Locales', 1, '2024-07-23 20:09:37', '2024-07-23 20:09:37'),
(9, 'Integración de Tecnologías Aplicadas en Mecatrónica', 1, '2024-07-23 20:14:55', '2024-07-23 20:14:55'),
...
(71, 1, 35, '2024-08-20 18:42:57', '2024-08-20 18:42:57');
...
INSERT INTO `redes_conocimiento` (`id_Red`, `nombre_red`, `estado_red`, `updated_at`, `created_at`) VALUES
(1, 'Red Modificada', 1, '2024-08-22 20:51:17', '2024-08-15 19:01:42'),
(2, 'Red Prueba 2', 1, '2024-08-16 19:49:56', '2024-08-16 19:49:56'),
(3, 'Red prueba 3', 1, '2024-08-16 20:27:54', '2024-08-16 20:27:54'),
(4, 'Red prueba 4', 1, '2024-08-16 20:54:53', '2024-08-16 20:54:53'),
(5, 'Red Prueba 5', 1, '2024-08-16 20:58:00', '2024-08-16 20:58:00');
